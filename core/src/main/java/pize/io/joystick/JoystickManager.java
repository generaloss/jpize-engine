...
public class JoystickManager{
    ...
    private JoystickManager(){
        ...
        glfwSetJoystickCallback((int joystickID, int event)->{
            switch(event){
                case GLFW_CONNECTED -> {joysticks.put(joystickID, new Joystick(joystickID));System.out.println("Connect Joystick");}
                case GLFW_DISCONNECTED -> {joysticks.remove(joystickID);System.out.println("Remove Joystick");}
            }
        });
    }
