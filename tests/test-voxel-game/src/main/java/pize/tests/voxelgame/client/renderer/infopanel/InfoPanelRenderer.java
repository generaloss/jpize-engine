...
public class InfoPanelRenderer implements Disposable{
    ...
    private final ClientGameRenderer gameRenderer;
    ...
    public InfoPanelRenderer(ClientGameRenderer gameRenderer){
    ...
    public void render(){
        ...
        final VoxelGame session = gameRenderer.getSession();
        ...
        info(new Component()
            ...
            .color(TextColor.ORANGE).text(level.getChunkManager().getChunks().size())
        );
        ...
        info(new Component()
            ...
            .color(TextColor.YELLOW).text(ChunkMeshBuilder.buildTime + " ms")
            .color(TextColor.BLUE).text("/")
            .color(TextColor.ORANGE).text(ChunkMeshBuilder.verticesNum)
        );
