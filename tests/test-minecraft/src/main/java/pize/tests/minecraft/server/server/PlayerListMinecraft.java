...
public class PlayerListMinecraft{
/*
    ...
    public PlayerListMinecraft(MinecraftServer p_i231425_1_, DynamicRegistries.Impl p_i231425_2_, PlayerData p_i231425_3_, int p_i231425_4_) {
