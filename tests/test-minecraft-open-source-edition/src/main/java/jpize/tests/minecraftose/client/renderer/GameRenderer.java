package jpize.tests.minecraftose.client.renderer;

import jpize.io.context.JpizeApplication;
import jpize.tests.minecraftose.Minecraft;
import jpize.tests.minecraftose.client.renderer.chat.ChatRenderer;
import jpize.tests.minecraftose.client.renderer.infopanel.ChunkInfoRenderer;
import jpize.tests.minecraftose.client.renderer.infopanel.InfoRenderer;
import jpize.tests.minecraftose.client.renderer.level.LevelRenderer;
import jpize.tests.minecraftose.client.renderer.text.TextComponentBatch;
