...
import jpize.tests.minecraftose.client.control.camera.perspective.CameraTarget;
import jpize.tests.minecraftose.client.control.camera.perspective.FirstPersonPlayerCameraTarget;
import jpize.tests.minecraftose.client.control.camera.perspective.ThirdPersonBackCameraTarget;
import jpize.tests.minecraftose.client.control.camera.perspective.ThirdPersonFrontCameraTarget;
...
public class GameCamera extends PerspectiveCamera{
    ...
    public void update(){
        ...
        final BlockProps block = game.getLevel().getBlockProps(position.xFloor(), position.yFloor(), position.zFloor());
