package pize.tests.minecraftosp.server.player;
...
import pize.tests.minecraftosp.main.net.packet.CBPacketAbilities;
...
import pize.tests.minecraftosp.main.net.packet.CBPacketTeleportPlayer;
