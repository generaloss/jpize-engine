...
import jpize.gui.constraint.ConstraintType;
import jpize.gui.constraint.RelativeConstraint;

import java.util.*;

import static jpize.gui.Align.*;
import static jpize.gui.LayoutType.CONSTRAINT;
