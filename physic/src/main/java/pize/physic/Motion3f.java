...
public class Motion3f extends Vec3f{
    ...
    public Motion3f(Vec3f vector){
        super(vector);
        max = 1;
    }
    
    
    public Motion3f collidedAxesToZero(Vec3f collidedMotion){
    ...
    public Motion3f clampToMax(boolean clampX, boolean clampY, boolean clampZ){
    ...
    public Motion3f clampToMax(){
        return clampToMax(true, true, true);
    }
    
    public Motion3f reduce(double reduce){
        return reduce(reduce, reduce, reduce);
    }
    
    public Motion3f reduceXZ(double reduce){
        return reduce(reduce, 0, reduce);
    }
    
    public Motion3f reduce(double reduceX, double reduceY, double reduceZ){
        final Vec3f normalized = copy().nor().abs();
    ...
    public Motion3f setMax(float max){
        this.max = max;
    ...
    @Override
    public Motion3f copy(){
        return new Motion3f(this);
    }
