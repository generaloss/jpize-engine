...
public class BoundingBox3{
    ...
    public BoundingBox3(Vec3f min, Vec3f max){
        this.min = min;
        this.max = max;
    }
    
    public BoundingBox3(BoundingBox3 box){
    ...
    public void resize(BoundingBox3 box){
    ...
    public BoundingBox3 copy(){
        return new BoundingBox3(this);
    }
